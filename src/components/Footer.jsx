        ...
        <div className="row">
          ...
          <div className="col-md-2 mb-4 text-center">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><a href="/adminLogin" className="text-light text-decoration-none">Login</a></li>
          ...
          <div className='text-center' >
            <p style={{fontSize:'10px'}}>©COPYRIGHT 2024,ALL RIGHT RESERVED| MEARN</p>
          </div>
        </div>
